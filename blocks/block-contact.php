...
?>
<section id="<?php echo $anchor; ?>" class="section eoe-block eoe-contact <?php echo $id; ?>">
	<div class="background fp-bg"></div>
	<div class="container is-fluid" >
		<div class="columns is-vcentered is-multiline">
			<div class="column rellax is-12 is-7-desktop is-offset-1-desktop">
				<img src="<?php echo get_template_directory_uri() ?>/static/eoe_animated.gif" alt="East of Everything Animation">
			</div>
			<div class="column rellax is-8 is-offset-3 is-offset-2-desktop is-offset-3-widescreen">
